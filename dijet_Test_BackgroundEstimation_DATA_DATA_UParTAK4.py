...
if __name__ == "__main__":
    ...
    combined_tree["Hcand_1_pt"] = tree_arr["Hcand_1_pt"][all_idx]
    combined_tree["Hcand_2_pt"] = tree_arr["Hcand_2_pt"][all_idx]
    combined_tree["Hcand_1_mass"] = tree_arr["Hcand_1_mass"][all_idx]
    combined_tree["Hcand_2_mass"] = tree_arr["Hcand_2_mass"][all_idx]
    combined_tree["Hcand_1_eta"] = tree_arr["Hcand_1_eta"][all_idx]
    combined_tree["Hcand_2_eta"] = tree_arr["Hcand_2_eta"][all_idx]
    combined_tree["Hcand_1_phi"] = tree_arr["Hcand_1_phi"][all_idx]
    combined_tree["Hcand_2_phi"] = tree_arr["Hcand_2_phi"][all_idx]
    combined_tree["HT_4j"] = tree_arr["HT_4j"][all_idx]
    ...
    mx_bin_edges = np.array([400,450,500,550,600,650,700,750,800,850,900,950,1000,1100,1200,1300,1400,1500,1600,1800,2000,2250,2500,2750,3000,3500,4000,4500])
