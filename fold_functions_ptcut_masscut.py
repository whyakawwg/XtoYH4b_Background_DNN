...
def processing(file_list, args=None):
    ...
    mass_cut_mask = (tree_arr["JetAK4_mass_1"] > 10) & (tree_arr["JetAK4_mass_2"] > 10) & \
                    (tree_arr["JetAK4_mass_3"] > 10) & (tree_arr["JetAK4_mass_4"] > 10) 
    ...
    common_mask = common_mask & pt_cut_mask & mass_cut_mask
    sig_mask = sig_mask & pt_cut_mask & mass_cut_mask
    bkg_mask = bkg_mask & pt_cut_mask & mass_cut_mask
