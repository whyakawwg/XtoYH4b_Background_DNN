...
script_dir="/data/dust/user/wanghaoy/XtoYH4b/work_scripts/fold10_evaluation.py"

plot_script_dir="/data/dust/user/wanghaoy/XtoYH4b/work_scripts/plot_10fold.py"
...
jobs["Evaluation_${train_region}vs2b_${special_name}"]="python3 fold10_evaluation.py --YEAR 2024 --isScaling 1 --isBalanceClass 1 --Model DNN --runType ${run_type} --TrainRegion ${train_region} --TestRegion ${test_region}"
