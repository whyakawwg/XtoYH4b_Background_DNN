...
plot_script_dir="/data/dust/user/wanghaoy/XtoYH4b/work_scripts/plot_4b_fold.py"
...
cd $output_dir
${jobs[$name]}
python3 plot_4b_fold.py --YEAR 2024 --isScaling 1 --isBalanceClass 1 --Model DNN --runType ${run_type} --TrainRegion ${train_region} --TestRegion ${test_region} --Nfold ${n_folds}
EOF
    chmod +x "$exe_file"
