...
def get_fold_hists(file, var_name, n_folds=10, scale_factor=1.0):
...
def get_fold_errors(file, var_name, n_folds=10):
...
def calculate_error_from_histograms(file, var_name, n_folds=10):
    """
    ...
    with open(log_filename2, "w") as f_log2:
        for var in vars_to_plot:
            ...
            if var == "Score":
                ...
                folds_y = get_fold_hists(f, var, n_folds=10, scale_factor=scale_factor)
                ...
                mean_hist, sys_errs_hist, = calculate_error_from_histograms(f, var, n_folds=10)
                ...
                fold_errors_2bw = get_fold_errors(f, var, n_folds=10) # purely statistical errors from each fold
                ...
                rax5w.fill_between(edges, r_band_low_hist, r_band_high_hist, step='post', color='gray', alpha=0.2)
