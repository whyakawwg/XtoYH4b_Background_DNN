...
def write_outputfile(output_file, input_dir, signals, backgrounds, data, histogram_name="hx",signal_systematics=[],lumi=1.):
    ...
    data_file = "/afs/desy.de/user/w/wanghaoy/Group_XToYHTo4b/SmallNtuples/Histograms/"+args.YEAR+"/"+"Output_"+data+".root"
...
input_dir = "/data/dust/group/cms/higgs-bb-desy/XToYHTo4b/SmallNtuples/Histograms/"+args.YEAR+"/SIGNAL/HLT_HT250/"
