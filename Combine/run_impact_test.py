...
def main():
    ...
    if not has_initial_fit_output():
        run_command("combineTool.py -M Impacts -d "+workspace+" -m 125 --robustFit 1 --doInitialFit --rMax 10 --rMin -5 --expectSignal "+args.expect_signal+" -t "+args.ntoys_impact)
    run_command("combineTool.py -M Impacts -d "+workspace+" -m 125 --robustFit 1 --doFits --rMax 10 --rMin -5 --expectSignal "+args.expect_signal+" -t "+args.ntoys_impact)
    run_command("combineTool.py -M Impacts -d "+workspace+" -m 125 --robustFit 1 --rMax 10 --rMin -5 -o "+out_file+".json")
